...
- Vyzkoušel jsem si vytvářet model "na zakázku"
	- měřil jsem požadované součástky tohoto projektu
	- modeloval jsem podle ideálních podmínek a následně jsem přidával vůle
	- tisknuli jsme hodně na rychlo, protože konečný termín byl jen týden před začátkem projektu
	- musel jsem kompromisovat s počtem prototypů za úpravy modelu, který musel být co nejblíž perfeknosti
